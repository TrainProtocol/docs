...
TRAIN has an on-chain [Discovery Registry](/protocol-spec/discovery) for protocol metadata to ensure users, auctions, and integrators can discover Solvers. Solvers will register their addresses and the routes they support.
