...
The [TRAIN Bridge dApp](https://app.train.tech) serves as the central interface for seamless cross-chain transactions. It submits user intents to the centralized [Auction Manager](/protocol/auction), receives the winning Solver quote, and orchestrates the [HTLC flow with recoverable secret generation](/protocol/atomic-swaps-secret_gen).
...
3. Execute the [HTLC flow](/protocol/atomic-swaps-secret_gen) (derive secret, lock funds, observe destination lock, reveal secret)
