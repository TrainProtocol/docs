...
- Connecting to the [Discovery registry](/protocol/discovery) and fetching available Solvers/networks.
- Connecting to the [Auction](/protocol/auction) to transmit the user's intent and get quotes from Solvers.
- Executing an [Atomic Swap](/protocol/atomic-swaps-prehtlc) flow.
