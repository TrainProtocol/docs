...
<Update label="2024-12-12" description="v0.1.5-testnets">
    - Released TRAIN [Bridge dApp](https://train.tech/app) to use [Signature flow](/protocol-spec/core) instead of the user doing 2 transactions; the user now does 1 transaction and 1 signature.
</Update>
...
<Update label="2024-11-27" description="v0.1-testnets">
    - Released the first version of the TRAIN protocol. Live [here](https://train.tech/app) on EVMs, Fuel, Starknet, Solana, and TON testnets.
